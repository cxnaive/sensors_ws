...
namespace oculii
{
    ...
    struct RadarDetectionData
    {
        ...
        float trueAlpha = 0.0;                 /*!< Detection horizontal angle (in radians) with respect to the orginal radar + yaw - used for tracker fusion */
        uint8_t radarId = 0;                   /*!< radarId - used for tracker fusion */
    ...
    struct RadarTrackerData
    {
        ...
        float z = 0;                         /*!< Track z position in Oculii radar coordinate */
